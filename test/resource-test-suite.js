...
module.exports = function (options) {
  ...
  for (const middlewareTypeName in Restypie.MIDDLEWARE_TYPES) {
    const middlewareType = Restypie.MIDDLEWARE_TYPES[middlewareTypeName];

    // const middlewareType = 'express';

    Restypie.setMiddlewareType(middlewareType);
     ...
     ********************************************** The tests suite ******************************************************
     ********************************************************************************************************************/
    describe(`@ Running test suite for ${middlewareType}`, function () {
